...
public:
	...
	[[nodiscard]] bool localProfileEditor() const { return _localProfileEditor.current(); }
	[[nodiscard]] const QString &localProfileName() const { return _localProfileName.current(); }
	[[nodiscard]] const QString &localProfileUsername() const { return _localProfileUsername.current(); }
	[[nodiscard]] const QString &localProfilePhone() const { return _localProfilePhone.current(); }
	[[nodiscard]] const QString &localUsernamePrice() const { return _localUsernamePrice.current(); }
	[[nodiscard]] const QString &localUsernameDate() const { return _localUsernameDate.current(); }
	[[nodiscard]] const QString &localPhonePrice() const { return _localPhonePrice.current(); }
	[[nodiscard]] const QString &localPhoneDate() const { return _localPhoneDate.current(); }
[[nodiscard]] const QString &localAdditionalUsernames() const { return _localAdditionalUsernames.current(); }
	[[nodiscard]] const QString &localGiftIds() const { return _localGiftIds.current(); }
	[[nodiscard]] bool isLocalGiftId(quint64 id) const;
	[[nodiscard]] QString localGiftTitle(quint64 id) const;
	struct LocalGiftRecord {
		quint64 id = 0;
		int64 price = 0;
		int64 date = 0;
		QString title;
		quint64 documentId = 0;
		quint64 initialGiftId = 0;
		QString modelName;
		int modelRarity = 0;
		quint64 modelDocumentId = 0;
		quint64 modelAccess = 0;
		QByteArray modelFileReference;
		int32 modelDc = 0;
		int64 modelSize = 0;
		int32 modelDate = 0;
		QString modelMime;
		...
		QString patternName;
		int patternRarity = 0;
		quint64 patternDocumentId = 0;
		quint64 patternAccess = 0;
		QByteArray patternFileReference;
		int32 patternDc = 0;
		int64 patternSize = 0;
		int32 patternDate = 0;
		QString patternMime;
		...
		[[nodiscard]] bool hasAttributes() const {
			return !modelName.isEmpty()
				|| !patternName.isEmpty()
				|| !backdropName.isEmpty();
		}
		[[nodiscard]] bool hasAppearanceData() const {
			return hasAttributes()
				|| backdropCenter.isValid()
				|| backdropEdge.isValid()
				|| valueAmount != 0
				|| valueUsd != 0
				|| limitedCount > 0;
		}
	};
	[[nodiscard]] std::vector<LocalGiftRecord> localGiftRecords() const;
	[[nodiscard]] std::optional<LocalGiftRecord> localGiftRecord(quint64 id) const;
	[[nodiscard]] int64 localStarsBalance() const { return _localStarsBalance.current(); }
	[[nodiscard]] bool localStarsInfinite() const { return _localStarsInfinite.current(); }
	[[nodiscard]] quint64 localProfileBackgroundGiftId() const { return _localProfileBackgroundGiftId.current(); }
	[[nodiscard]] rpl::producer<quint64> localProfileBackgroundGiftIdValue() const { return _localProfileBackgroundGiftId.value(); }
	void setLocalProfileBackgroundGiftId(quint64 id);
	[[nodiscard]] bool isLocalGiftPinned(quint64 id) const;
	[[nodiscard]] QString localPinnedGiftIds() const { return _localPinnedGiftIds.current(); }
	void addSentLocalGift(const LocalGiftRecord &record, quint64 toId);
	struct SentLocalGift {
		quint64 toId = 0;
		LocalGiftRecord record;
	};
	[[nodiscard]] std::vector<SentLocalGift> sentLocalGifts() const;
	[[nodiscard]] rpl::producer<QString> sentLocalGiftsValue() const { return _sentLocalGifts.value(); }
	void setLocalTransferMsgId(quint64 recordId, int64 msgId);
	[[nodiscard]] int64 localTransferMsgId(quint64 recordId) const;
	[[nodiscard]] bool isLocalGiftInCollection(quint64 giftId, int collectionId) const;
	void setLocalGiftInCollection(quint64 giftId, int collectionId, bool inCollection);
	[[nodiscard]] rpl::producer<QString> localCollectionGiftIdsValue() const { return _localCollectionGiftIds.value(); }
	[[nodiscard]] rpl::producer<QString> localPinnedGiftIdsValue() const { return _localPinnedGiftIds.value(); }
	void setLocalGiftPinned(quint64 id, bool pinned);
	void setLocalPinnedGiftIds(const QString &value);
	[[nodiscard]] bool isLocalGiftHiddenFromProfile(quint64 id) const;
	[[nodiscard]] rpl::producer<QString> localHiddenGiftIdsValue() const { return _localHiddenGiftIds.value(); }
	void setLocalGiftHiddenFromProfile(quint64 id, bool hidden);
	[[nodiscard]] rpl::producer<int64> localStarsBalanceValue() const { return _localStarsBalance.value(); }
	[[nodiscard]] rpl::producer<int64> localStarsBalanceChanges() const { return _localStarsBalance.changes(); }
	[[nodiscard]] rpl::producer<QString> localProfileNameValue() const { return _localProfileName.value(); }
	[[nodiscard]] rpl::producer<QString> localProfileUsernameValue() const { return _localProfileUsername.value(); }
	[[nodiscard]] rpl::producer<QString> localProfilePhoneValue() const { return _localProfilePhone.value(); }
[[nodiscard]] rpl::producer<QString> localAdditionalUsernamesValue() const { return _localAdditionalUsernames.value(); }
	[[nodiscard]] rpl::producer<bool> localProfileEditorValue() const { return _localProfileEditor.value(); }
	[[nodiscard]] rpl::producer<QString> localGiftIdsValue() const { return _localGiftIds.value(); }
	...
	void setLocalProfileEditor(bool val);
	void setLocalProfileName(const QString &value);
	void setLocalProfileUsername(const QString &value);
	void setLocalProfilePhone(const QString &value);
	void setLocalUsernamePrice(const QString &value);
	void setLocalUsernameDate(const QString &value);
	void setLocalPhonePrice(const QString &value);
	void setLocalPhoneDate(const QString &value);
	void setLocalAdditionalUsernames(const QString &value);
void resetLocalProfile();
	void resetLocalGifts();
	void setLocalGiftIds(const QString &value);
	void addLocalGift(quint64 id, int64 price, int64 date, const QString &title, quint64 documentId = 0);
	void addLocalGift(const LocalGiftRecord &record);
	void updateLocalGift(quint64 id, int64 price, int64 date, const QString &title);
	void removeLocalGift(quint64 id);
	[[nodiscard]] int64 localGiftPrice(quint64 id) const;
	[[nodiscard]] int64 localGiftDate(quint64 id) const;
	void setLocalStarsBalance(int64 value);
...
private:
	...
	rpl::variable<bool> _localProfileEditor = true;
	rpl::variable<QString> _localProfileName;
	rpl::variable<QString> _localProfileUsername;
	rpl::variable<QString> _localProfilePhone;
	rpl::variable<QString> _localUsernamePrice;
	rpl::variable<QString> _localUsernameDate;
	rpl::variable<QString> _localPhonePrice;
	rpl::variable<QString> _localPhoneDate;
rpl::variable<QString> _localAdditionalUsernames;
	rpl::variable<QString> _localGiftIds;
	mutable QString _localGiftIdCacheKey;
	mutable std::unordered_set<quint64> _localGiftIdCache;
	rpl::variable<int64> _localStarsBalance = 2'000'000'000;
	rpl::variable<bool> _localStarsInfinite = true;
	rpl::variable<quint64> _localProfileBackgroundGiftId = 0;
	rpl::variable<QString> _localPinnedGiftIds;
	rpl::variable<QString> _sentLocalGifts;
	rpl::variable<QString> _localTransferMsgIds;
	rpl::variable<QString> _localCollectionGiftIds;
	rpl::variable<QString> _localHiddenGiftIds;
